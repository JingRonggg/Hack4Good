...
const AdminStorePage: React.FC = () => {
    const actionItems = [
        { id: "manage", icon: <FaEdit />, label: "Manage Items", route: "/admin/manage-items" },
        { id: "approve", icon: <FaCheckSquare />, label: "Approve Purchases", route: "/admin/approve-purchases" },
      ];
  ...
  return (
    <div style={{ width: "70vw" }}>
      ...
      <div style={{ display:"flex", alignItems: "center", gap: "10px", cursor: "pointer" }} onClick={toggleInventory} >
      ...
      <div style={{ display:"flex", alignItems: "center", gap: "10px", cursor: "pointer" }} onClick={toggleHistory} >
